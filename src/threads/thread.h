...
struct thread
  {
    ...
    /* file desciptor for each file in the file list */
    int fd;
      /*--------------------------------- */    
    ...
    bool loaded_success;          /* if process is loaded successfully or not*/

    struct thread *parent ;

    //struct process *pro ;   /* to be able to return the process from thecurrent thread */
#ifdef USERPROG
